...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/youtube.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/youtube.js":
/*!*****************************************!*\
  !*** ./app/javascript/packs/youtube.js ***!
  \*****************************************/
/*! no exports provided */
...
var lang = trix__WEBPACK_IMPORTED_MODULE_0___default.a.config.lang;
trix__WEBPACK_IMPORTED_MODULE_0___default.a.config.toolbar = {
...
var EmbedController = /*#__PURE__*/function () {
  function EmbedController(element) {
  ...
  _createClass(EmbedController, [{
    ...
    key: "didInput",
    value: function didInput(event) {
      var value = event.target.value.trim();
      var matches = value.match(this.pattern);
      console.log(value, matches); // When patterns are loaded, we can just fetch the embed code

      if (matches != null) {
        this.fetch(matches[2]); // No embed code, just reset the form
      } else {
        this.reset();
      }
    }
    ...
    value: function fetch(value) {
      _rails_ujs__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
        url: "/youtube/".concat(encodeURIComponent(value)),
        type: 'get',
    ...
    key: "embed",
    value: function embed(event) {
      if (this.currentEmbed == null) {
        return;
      }

      var attachment = new trix__WEBPACK_IMPORTED_MODULE_0___default.a.Attachment(this.currentEmbed);
      this.editor.insertAttachment(attachment);
      this.element.focus();
    }
  }, {
    key: "showEmbed",
    value: function showEmbed(embed) {
...
/******/ });
//# sourceMappingURL=youtube-e7a1758e6863243d1a16.js.map